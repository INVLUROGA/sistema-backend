...
const Client_Contrato = async (dataInfo) => {
  ...
  //Primera fila
  const nombresCliente = firstPage.drawText(
    `${
      dataInfo.nombresCliente
        ? dataInfo.nombresCliente.toLowerCase().charAt(0).toUpperCase() +
          dataInfo.nombresCliente.toLowerCase().slice(1)
        : ""
    }`,
    {
      x: 175,
  ...
  const apPaternoCliente = firstPage.drawText(
    `${
      dataInfo.apPaternoCliente
        ? dataInfo.apPaternoCliente.toLowerCase().charAt(0).toUpperCase() +
          dataInfo.apPaternoCliente.toLowerCase().slice(1)
        : ""
    }`,
    {
      x: 175,
  ...
  const apMaternoCliente = firstPage.drawText(
    `${
      dataInfo.apMaternoCliente
        ? dataInfo.apMaternoCliente.toLowerCase().charAt(0).toUpperCase() +
          dataInfo.apMaternoCliente.toLowerCase().slice(1)
        : ""
    }`,
    {
      x: 388,
  ...
  console.log("pasa el contrato 3777");
