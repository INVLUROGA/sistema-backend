...
const { terminologiasPorEntidad, comboMesActivoVentas, terminologiasGastosxEmpresa, postterminologiasGastosxEmpresa, putterminologiasGastosxEmpresa, deleteterminologiasGastosxEmpresa } = require("../controller/terminologia.controller");
const router = Router();
...
router.put("/terminologiagastoxid/delete/:id", deleteterminologiasGastosxEmpresa)
